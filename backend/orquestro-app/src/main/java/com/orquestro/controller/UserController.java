 ...
 * Provides endpoints for listing, viewing, creating, updating, and managing account security status.
...
public class UserController {
    ...
    /**
     * Creates a new user administratively.
     * 
     * @param request the user creation data.
     * @return 201 Created with the created UserResponseDTO.
     */
    @PostMapping
