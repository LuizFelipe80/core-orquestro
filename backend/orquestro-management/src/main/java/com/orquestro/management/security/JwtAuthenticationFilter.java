...
/**
 * Filter responsible for intercepting every HTTP request to validate JWT tokens.
 * If a valid token is found in the 'Authorization' header, it sets the 
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    /**
     * Internal filter logic to check for JWT and authenticate the user.
     */
    @Override
    protected void doFilterInternal(
        ...
        if (userEmail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            // 4. If token is valid, create the authentication token and set it in the context
